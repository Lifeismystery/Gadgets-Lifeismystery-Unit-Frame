...
local LifeismysteryRaidFrameDps = WT.UnitFrame:Template("LifeismysteryRaidFrameDps")
LifeismysteryRaidFrameDps.Configuration.Name = "Lifeismystery Raid Frame Dps"
LifeismysteryRaidFrameDps.Configuration.RaidSuitable = true
LifeismysteryRaidFrameDps.Configuration.UnitSuitable = false
LifeismysteryRaidFrameDps.Configuration.FrameType = "Frame"
LifeismysteryRaidFrameDps.Configuration.Width = 50
LifeismysteryRaidFrameDps.Configuration.Height = 20
LifeismysteryRaidFrameDps.Configuration.Resizable = { 55, 40, 500, 70 }
LifeismysteryRaidFrameDps.Configuration.SupportsHoTPanel = true
LifeismysteryRaidFrameDps.Configuration.SupportsDebuffPanel = true

--------------------------------------------------------------
function LifeismysteryRaidFrameDps:Construct(options)
	local template =
	{
		elements = 
		{
			...
			}, 
			{
				...
				attach = {
					{ point="TOPLEFT", element="frame", targetPoint="TOPLEFT", offsetX=2, offsetY=15 },
				...
				raidHealthColorDps={r=1,g=1,b=1, a=0.8},
				colorBinding="raidHealthColorDps",					
			},
			{
			...
			},
			{
				...
				attach = {{  point="TOPLEFT", element="barHealth", targetPoint="TOPLEFT", offsetX=2, offsetY=-2 }}, 
			...
			},		
			{
				...
				attach = {{ point="TOPCENTER", element="frame", targetPoint="TOPCENTER", offsetX=0, offsetY=-3 }},
				visibilityBinding="name",
				text="{nameShort}", maxLength=6, default="", outline=true,
				colorBinding="NameColor", font = "Enigma",
			},
			{
				id="labelStatus", type="Label", parent="frame", layer=20,
				attach = {{ point="BOTTOMCENTER", element="frame", targetPoint="BOTTOMCENTER", offsetX=0, offsetY=0 }},
	...
	self:EventAttach(
		...
		function(el)
			...
			local fracWidth = newWidth / LifeismysteryRaidFrameDps.Configuration.Width
			local fracHeight = newHeight / LifeismysteryRaidFrameDps.Configuration.Height
...
WT.Unit.CreateVirtualProperty("raidHealthColorDps", { "id", "offline"},
	function(unit)
