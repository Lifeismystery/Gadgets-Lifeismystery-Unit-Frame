...
--------------------------------------------------------------
function LifeismysteryTanksRaidFrame:Construct(options)
	local template =
	{
		elements = 
		{
	...
	self:EventAttach(
		...
		function(el)
			...
			local fracWidth = newWidth / LifeismysteryTanksRaidFrame.Configuration.Width
			local fracHeight = newHeight / LifeismysteryTanksRaidFrame.Configuration.Height
...
WT.Unit.CreateVirtualProperty("TanksHealthColor", { "id", "offline"},
	function(unit)
